...
public class FinishShootLEDCommand extends Command {
    ...
    public FinishShootLEDCommand(IndicatorSubsystem indicatorSubsystem) {
    ...
    public void initialize() {
        ...
        indicatorSubsystem.getLed()
                .setPattern(new BlinkingPattern(Color.kRed, 0.2));
    }
